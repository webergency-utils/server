...
const __parse_fdba127064c2547c_strip_json = (function (input, options) { const path = ""; const reviver = options && options.reviver; const transform = options && options.transform; const text = __tcRuntime.expectString(input, path); let obj; try {
    ...
    obj = __tcRuntime.reviveTree(obj, reviver);
} return (function (o, p) { o = __tcRuntime.expectObject(o, p); const res = { "id": __tcRuntime.applyParseTransform(__tcRuntime.expectNumber(o.id, (path) ? (path) + "." + "id" : "id"), (path) ? (path) + "." + "id" : "id", transform, "number", [], obj), "tags": (function (arr, p) { __tcRuntime.expectArray(arr, p); return arr.map((item, i) => { const itemP = (p ? p + "[" + i + "]" : "[" + i + "]"); return __tcRuntime.applyParseTransform(__tcRuntime.expectString(item, itemP), itemP, transform, "string", [], obj); }); })(o.tags, (path) ? (path) + "." + "tags" : "tags") }; if (o.user !== undefined) {
    res["user"] = __tcRuntime.parseUnion(o.user, (path) ? (path) + "." + "user" : "user", "Type<User|undefined>", [(v, p) => (function (v, path) { if (v !== undefined) {
...
const __parse_fdba127064c2547c_strip_query = (function (input, options) { const path = ""; const reviver = options && options.reviver; const transform = options && options.transform; const text = __tcRuntime.expectString(input, path); let rawQuery = __tcRuntime.parseQueryString(text); if (reviver) {
    rawQuery = __tcRuntime.reviveTree(rawQuery, reviver);
} return (function (o, p) { o = __tcRuntime.expectObject(o, p); const res = { "id": __tcRuntime.applyParseTransform(__tcRuntime.coerceNumber(o.id, (path) ? (path) + "." + "id" : "id"), (path) ? (path) + "." + "id" : "id", transform, "number", [], rawQuery), "tags": __tcRuntime.coerceArray(o.tags, (path) ? (path) + "." + "tags" : "tags", (item, itemP) => __tcRuntime.applyParseTransform(__tcRuntime.expectString(item, itemP), itemP, transform, "string", [], rawQuery)) }; if (o.user !== undefined) {
    res["user"] = __tcRuntime.parseUnion(o.user, (path) ? (path) + "." + "user" : "user", "Type<User|undefined>", [(v, p) => (function (v, path) { if (v !== undefined) {
            throw new __tcRuntime.ParseError(path, "Type<undefined>");
...
const __ser_a068761681a0a813_strip_json = (function (input, options) { const transform = options && options.transform; const replacer = options && options.replacer; const out = (function (obj) { if (typeof obj !== "object" || obj === null || Array.isArray(obj)) {
    throw new __tcRuntime.SerializationError("", "Type<Object>");
} let parts = []; parts.push("\"success\":" + (function () { const __sv = __tcRuntime.applySerializeTransform(obj.success, "success", transform, "boolean", [], input); return (typeof __sv === "boolean" ? (__sv ? "true" : "false") : (function () { throw new __tcRuntime.SerializationError("success", "Type<boolean>"); })()); })()); parts.push("\"data\":" + (function (val) { switch (val && val["type"]) {
    ...
    } let parts = []; parts.push("\"id\":" + (function () { const __sv = __tcRuntime.applySerializeTransform(obj.id, (("data") + "." + "data") + "." + "id", transform, "number", [], input); return (typeof __sv === "number" && !Number.isNaN(__sv) ? String(__sv) : (function () { throw new __tcRuntime.SerializationError((("data") + "." + "data") + "." + "id", "Type<number>"); })()); })()); parts.push("\"tags\":" + __tcRuntime.serializeArray(obj.tags, (item, i) => (function () { const __sv = __tcRuntime.applySerializeTransform(item, ((("data") + "." + "data") + "." + "tags") + "[" + i + "]", transform, "string", [], input); return __tcRuntime.serializeString(__sv, ((("data") + "." + "data") + "." + "tags") + "[" + i + "]"); })(), (("data") + "." + "data") + "." + "tags")); return "{" + parts.join(",") + "}"; })(obj.data)); return "{" + parts.join(",") + "}"; })(obj.data);
...
const __ser_a042f9877fc2376a_strip_json = (function (input, options) { const transform = options && options.transform; const replacer = options && options.replacer; const out = (function (obj) { if (typeof obj !== "object" || obj === null || Array.isArray(obj)) {
    throw new __tcRuntime.SerializationError("", "Type<Object>");
} let parts = []; parts.push("\"success\":" + (function () { const __sv = __tcRuntime.applySerializeTransform(obj.success, "success", transform, "boolean", [], input); return (typeof __sv === "boolean" ? (__sv ? "true" : "false") : (function () { throw new __tcRuntime.SerializationError("success", "Type<boolean>"); })()); })()); parts.push("\"data\":" + __tcRuntime.serializeArray(obj.data, (item, i) => __tcRuntime.serializeUnion(item, ("data") + "[" + i + "]", "Type<string|number>", [val => (function () { const __sv = __tcRuntime.applySerializeTransform(val, ("data") + "[" + i + "]", transform, "string", [], input); return __tcRuntime.serializeString(__sv, ("data") + "[" + i + "]"); })(), val => (function () { const __sv = __tcRuntime.applySerializeTransform(val, ("data") + "[" + i + "]", transform, "number", [], input); return (typeof __sv === "number" && !Number.isNaN(__sv) ? String(__sv) : (function () { throw new __tcRuntime.SerializationError(("data") + "[" + i + "]", "Type<number>"); })()); })()]), "data")); return "{" + parts.join(",") + "}"; })(input); if (replacer) {
    try {
        return JSON.stringify(JSON.parse(out), replacer);
    }
    catch (e) {
...
const __ser_d0b53ff733685c2c_strip_json = (function (input, options) { const transform = options && options.transform; const replacer = options && options.replacer; const out = (function (obj) { if (typeof obj !== "object" || obj === null || Array.isArray(obj)) {
    ...
    parts.push("\"user\":" + __tcRuntime.serializeUnion(obj.user, ("data") + "." + "user", "Type<User|undefined>", [val => (function (obj) { if (typeof obj !== "object" || obj === null || Array.isArray(obj)) {
            throw new __tcRuntime.SerializationError(("data") + "." + "user", "Type<Object>");
        } let parts = []; parts.push("\"name\":" + (function () { const __sv = __tcRuntime.applySerializeTransform(obj.name, (("data") + "." + "user") + "." + "name", transform, "string", [], input); return __tcRuntime.serializeString(__sv, (("data") + "." + "user") + "." + "name"); })()); parts.push("\"age\":" + (function () { const __sv = __tcRuntime.applySerializeTransform(obj.age, (("data") + "." + "user") + "." + "age", transform, "number", [], input); return (typeof __sv === "number" && !Number.isNaN(__sv) ? String(__sv) : (function () { throw new __tcRuntime.SerializationError((("data") + "." + "user") + "." + "age", "Type<number>"); })()); })()); return "{" + parts.join(",") + "}"; })(val), val => (val === undefined ? "null" : (function () { throw new __tcRuntime.SerializationError(("data") + "." + "user", "Type<undefined>"); })())]));
} parts.push("\"tags\":" + __tcRuntime.serializeArray(obj.tags, (item, i) => (function () { const __sv = __tcRuntime.applySerializeTransform(item, (("data") + "." + "tags") + "[" + i + "]", transform, "string", [], input); return __tcRuntime.serializeString(__sv, (("data") + "." + "tags") + "[" + i + "]"); })(), ("data") + "." + "tags")); return "{" + parts.join(",") + "}"; })(obj.data)); return "{" + parts.join(",") + "}"; })(input); if (replacer) {
    try {
        return JSON.stringify(JSON.parse(out), replacer);
    }
    catch (e) {
...
const __ser_d9bb28ea073c815e_strip_json = (function (input, options) { const transform = options && options.transform; const replacer = options && options.replacer; const out = (function (obj) { if (typeof obj !== "object" || obj === null || Array.isArray(obj)) {
    throw new __tcRuntime.SerializationError("", "Type<Object>");
} let parts = []; parts.push("\"success\":" + (function () { const __sv = __tcRuntime.applySerializeTransform(obj.success, "success", transform, "boolean", [], input); return (typeof __sv === "boolean" ? (__sv ? "true" : "false") : (function () { throw new __tcRuntime.SerializationError("success", "Type<boolean>"); })()); })()); parts.push("\"tags\":" + __tcRuntime.serializeArray(obj.tags, (item, i) => (function () { const __sv = __tcRuntime.applySerializeTransform(item, ("tags") + "[" + i + "]", transform, "string", [], input); return __tcRuntime.serializeString(__sv, ("tags") + "[" + i + "]"); })(), "tags")); return "{" + parts.join(",") + "}"; })(input); if (replacer) {
    try {
        return JSON.stringify(JSON.parse(out), replacer);
    }
    catch (e) {
...
const __ser_78d9364193f14947_strip_json = (function (input, options) { const transform = options && options.transform; const replacer = options && options.replacer; const out = __tcRuntime.serializeArray(input, (item, i) => (function () { const __sv = __tcRuntime.applySerializeTransform(item, "[" + i + "]", transform, "string", [], input); return __tcRuntime.serializeString(__sv, "[" + i + "]"); })(), ""); if (replacer) {
    try {
        return JSON.stringify(JSON.parse(out), replacer);
    }
    catch (e) {
...
const __ser_e932e0ca2e5a5a04_strip_json = (function (input, options) { const transform = options && options.transform; const replacer = options && options.replacer; const out = __tcRuntime.serializeArray(input, (item, i) => (function () { const __sv = __tcRuntime.applySerializeTransform(item, "[" + i + "]", transform, "number", [], input); return (typeof __sv === "number" && !Number.isNaN(__sv) ? String(__sv) : (function () { throw new __tcRuntime.SerializationError("[" + i + "]", "Type<number>"); })()); })(), ""); if (replacer) {
    try {
        return JSON.stringify(JSON.parse(out), replacer);
    }
    catch (e) {
